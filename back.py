...
def get_hardcoded_funds():
    tarpon_returns = {
        ...
        '2025-12': 0.0112, '2026-01': 0.0596, '2026-02': 0.0156  # Atualizado jan/fev 2026 
    }
    ...
    spx_patriot_returns = {
        ...
        '2026-01': 0.0914, '2026-02': 0.0286  # Atualizado jan/fev 2026 
    }

    # NOVOS DADOS REAL INVESTOR (Extraídos do relatório de fev/2026) 
    real_investor_returns = {
        ...
        '2024-01': -0.0378, '2024-02': 0.0328, '2024-03': 0.0057, '2024-04': -0.0465, '2024-05': -0.0186, '2024-06': 0.0082, '2024-07': 0.0167, '2024-08': 0.0657, '2024-09': -0.0352, '2024-10': -0.0510, '2024-11': -0.0496, '2024-12': -0.0140,
        ...
        '2026-01': 0.0724, '2026-02': 0.0502  # Dados recentes 
    }
    ...
    df = pd.DataFrame({
        ...
        'Real Investor': pd.Series(real_investor_returns)  # Novo fundo incluído
    })
